  ...
  const projects = [
    {
      title: "Countdown App",
      description:
        "A React-based countdown timer with sharing capabilities and customizable messages.",
    ...
    },
    {
      ...
      description:
        "An AI-powered application that generates personalized bedtime stories for children.",
    ...
    },
    {
      ...
      description:
        "A modern, single-page E-commerce website with smooth scrolling and responsive design.",
      tags: ["HTML", "CSS", "Javascript"],
      link: "https://kyaw-min-htet.github.io/Ecommerce_template/",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              ...
              >
                ...
                <div
                  className={`h-48 bg-gradient-to-br ${project.gradient} relative overflow-hidden group`}
                >
                ...
                <div className="p-8 flex-1 flex flex-col">
                  ...
                  >
                    ...
                    <span className="transform transition-transform group-hover/btn:translate-x-2">
                      →
                    </span>
